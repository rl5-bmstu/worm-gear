...
Node {
    ...
    Node {
        ...
        Model {
            ...
            eulerRotation.y: -90
            eulerRotation.x: dvigSmallIndicatorAngle
            materials: [
                shape_017_material
            ]
        }
        ...
        Model {
            ...
            y: 0.140229
            z: 0.00191476
            rotation: Qt.quaternion(-2.04212e-07, 0, 0.721308, -0.692615)
        ...
        Model {
            ...
            eulerRotation.z: 90
            eulerRotation.y: -90
            eulerRotation.x: dvigIndicatorAngle
            materials: [
                shape_104_material
            ]
        }
        Model {
            ...
            eulerRotation.z: 90
            eulerRotation.y: -90
            eulerRotation.x: nagrIndicatorAngle
            materials: [
                shape_118_material
            ]
        }
        Model {
            ...
            eulerRotation.z: 90
            eulerRotation.y: -90
            eulerRotation.x: nagrSmallIndicatorAngle
            materials: [
                shape_123_material
            ]
        }
